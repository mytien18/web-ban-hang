  ...
  <table width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #eee">
    ...
    <tr>
      <td style="padding:20px">
        ...
        <p style="margin:0 0 12px 0;line-height:1.6">Bạn đã yêu cầu <strong>đặt lại mật khẩu</strong> cho tài khoản của bạn.</p>
        <p style="margin:0 0 12px 0;line-height:1.6">Đây là <strong>mã OTP</strong> để xác thực yêu cầu đặt lại mật khẩu:</p>
        ...
        <p style="margin:0 0 12px 0;line-height:1.6;color:#d32f2f"><strong>⚠️ Lưu ý:</strong> Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này và kiểm tra bảo mật tài khoản của bạn.</p>
